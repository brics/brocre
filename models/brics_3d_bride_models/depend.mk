...
DEPEND_ABI.brics_3d_bride_models?=    brics_3d_bride_models>=0.1
DEPEND_DIR.brics_3d_bride_models?=    ../../models/brics_3d_bride_models

SYSTEM_SEARCH.brics_3d_bride_models=models/brics_3d_bride_models/brics_3d_bride_filtering/CMakeLists.txt
endif
